...
grep ansible /etc/pve/priv/authorized_keys >tkeys
export ssh_keyfile=tkeys
...
#reate_template 912 "temp-ubuntu-23-10" "ubuntu-23.10-server-cloudimg-amd64.img"
#24.04 (Noble Numbat)
wget "https://cloud-images.ubuntu.com/releases/24.04/release/ubuntu-24.04-server-cloudimg-amd64.img"
sudo virt-customize --install qemu-guest-agent,emacs-nox,emacs-nox -a ubuntu-24.04-server-cloudimg-amd64.img
scp ubuntu-24.04-server-cloudimg-amd64.img root@heartogold:
ssh -XA root@heartogold ./create_template.sh 1102 "deepthot-24-04" "ubuntu-24.04-server-cloudimg-amd64.img"
